...
int main()
{
    student s1("Akash Bhat", 01, "Jammu", 100); // student constructor is called for student 1 and we are  passing values to constructor.
    s1.display();


    student s2("Tanish Gupta", 02, "Udhampur", 99); // student constructor is called for student 2 and we are passing values to constructor.
    s2.display();


    course c1("Programming with c++ Lab", 411, "Mr.Anil Gupta", "Akash Bhat"); // course constructor is called for student 1 and we are passing values to constructor.
    c1.disp();


    course c2("Programming with c++ Lab", 411, "Mr.Anil Gupta", "Tanish Gupta"); // course constructor is called for student 2 and we are passing values to constructor.
    c2.disp();
    return 0;
}